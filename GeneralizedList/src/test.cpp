...
void TestDepth() {
  ...
  string gen_list_string2_6 = "E(B(C(a)),D(a),G(#));";
  ...
  cout<<"\""<<gen_list_string1<<"\""<<" depth: "<<gen_list1.Depth()<<endl;//1
  cout<<"\""<<gen_list_string1_1<<"\""<<" depth: "<<gen_list1_1.Depth()<<endl;//1

  cout<<"\""<<gen_list_string2<<"\""<<" depth: "<<gen_list2.Depth()<<endl;//2
  cout<<"\""<<gen_list_string2_1<<"\""<<" depth: "<<gen_list2_1.Depth()<<endl;//2
  cout<<"\""<<gen_list_string2_2<<"\""<<" depth: "<<gen_list2_2.Depth()<<endl;//2
  cout<<"\""<<gen_list_string2_3<<"\""<<" depth: "<<gen_list2_3.Depth()<<endl;//2
  cout<<"\""<<gen_list_string2_6<<"\""<<" depth: "<<gen_list2_6.Depth()<<endl;//2
